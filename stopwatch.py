...
#------------------------------Screen management
    root = Tk()
    root.title("Stopwatch made by Hackehunt")
    width = 500
    height = 300
...
#-----------------------------Buttons
    ...
    Exit.pack(side=LEFT)
#-----------------------------Labels
    Title = Label(Top, text="StopWatch Hackehunt", font=("arial", 20), fg="white", bg="blue")
    Title.pack(fill=X)
...
class StopWatch(Frame):
    ...
    def MakeWidget(self):
        timeText = Label(self, textvariable=self.timestr, font=("times new roman", 45), fg="Maroon", bg="White")
